...
function Menghub:MakeNotify(NotifyConfig)
    ...
    spawn(function()
        ...
        if not CoreGui.NotifyGui:FindFirstChild("NotifyLayout") then
            ...
            NotifyLayout.Size = UDim2.new(0, 240, 1, 0)
                ...
                for _, v in CoreGui.NotifyGui.NotifyLayout:GetChildren() do
                    if v:IsA("Frame") then
                        TweenService:Create(v,
                            ...
                            { Position = UDim2.new(0, 0, 0, count * (v.Size.Y.Offset + 6)) }
                        ):Play()
                        count = count + 1
                    end
                end
        ...
        NotifyFrame.Size = UDim2.new(1, 0, 0, 28)
        NotifyFrame.Position = UDim2.new(0, 300, 0, posY)
        NotifyFrame.Name = "NotifyFrame"
        NotifyFrame.Parent = CoreGui.NotifyGui.NotifyLayout

        -- pill background
        local Pill = Instance.new("Frame")
        Pill.BackgroundColor3 = Color3.fromRGB(14, 14, 18)
        Pill.BorderSizePixel = 0
        Pill.Size = UDim2.new(1, 0, 1, 0)
        Pill.Position = UDim2.new(0, 0, 0, 0)
        Pill.Parent = NotifyFrame
        ...
        Label.Text = NotifyConfig.Content
        ...
        -- garis warna di bawah (highlight keyword terakhir, kayak screenshot)
        local Bar = Instance.new("Frame")
        Bar.BackgroundColor3 = NotifyConfig.Color
        ...
        function NotifyFunction:Close()
            ...
            TweenService:Create(NotifyFrame,
                ...
                { Position = UDim2.new(0, 300, 0, NotifyFrame.Position.Y.Offset) }
            ):Play()
