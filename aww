...
function Menghub:MakeNotify(NotifyConfig)
    ...
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(176, 110, 243)
    ...
    spawn(function()
        ...
        if not CoreGui.NotifyGui:FindFirstChild("NotifyLayout") then
            ...
            NotifyLayout.Size = UDim2.new(0, 330, 1, 0)
        ...
        for i, v in CoreGui.NotifyGui.NotifyLayout:GetChildren() do
            NotifyPosHeight = -(v.Position.Y.Offset) + v.Size.Y.Offset + 10
        end
        ...
        NotifyFrame.Size = UDim2.new(1, 0, 0, 64)
        NotifyFrame.Name = "NotifyFrame"
        NotifyFrame.AnchorPoint = Vector2.new(0, 1)
        NotifyFrame.Position = UDim2.new(0, 0, 1, -NotifyPosHeight)
        NotifyFrame.Parent = CoreGui.NotifyGui.NotifyLayout

        NotifyFrameReal.BackgroundColor3 = Color3.fromRGB(26, 27, 32)
        ...
        IconBox.BackgroundColor3 = Color3.fromRGB(176, 110, 243)
        ...
        IconBox.Parent = NotifyFrameReal

        IconBoxCorner.CornerRadius = UDim.new(0, 8)
        IconBoxCorner.Parent = IconBox

        IconImage.Image = "rbxassetid://99236135648613"
        IconImage.BackgroundTransparency = 1
        IconImage.BorderSizePixel = 0
        IconImage.AnchorPoint = Vector2.new(0.5, 0.5)
        IconImage.Position = UDim2.new(0.5, 0, 0.5, 0)
        IconImage.Size = UDim2.new(0.78, 0, 0.78, 0)
        IconImage.ScaleType = Enum.ScaleType.Fit
        IconImage.ImageColor3 = Color3.fromRGB(176, 110, 243)
        IconImage.Parent = IconBox

        ContentFrame.BackgroundTransparency = 1
        ContentFrame.BorderSizePixel = 0
        ContentFrame.Position = UDim2.new(0, 54, 0, 0)
        ContentFrame.Size = UDim2.new(1, -64, 1, 0)
        ...
        TopRow.Position = UDim2.new(0, 0, 0, 8)
        TopRow.Name = "TopRow"
        TopRow.Parent = ContentFrame

        TitleLabel.Font = Enum.Font.GothamBold
        TitleLabel.Text = NotifyConfig.Title
        TitleLabel.TextColor3 = Color3.fromRGB(232, 232, 240)
        ...
        DescLabel.Position = UDim2.new(0, TitleLabel.TextBounds.X + 6, 0, 0)
        DescLabel.Parent = TopRow
        ...
        CloseIcon.ImageColor3 = Color3.fromRGB(130, 130, 140)
        CloseIcon.AnchorPoint = Vector2.new(0.5, 0.5)
        CloseIcon.BackgroundTransparency = 1
        CloseIcon.Position = UDim2.new(0.5, 0, 0.5, 0)
        CloseIcon.Size = UDim2.new(0.65, 0, 0.65, 0)
        CloseIcon.Parent = CloseBtn

        MsgLabel.Font = Enum.Font.Gotham
        MsgLabel.Text = NotifyConfig.Content
        MsgLabel.TextColor3 = Color3.fromRGB(160, 160, 175)
        ...
        MsgLabel.Size = UDim2.new(1, 0, 0, 14 + (14 * (MsgLabel.TextBounds.X // MsgLabel.AbsoluteSize.X)))

        local totalHeight = MsgLabel.AbsoluteSize.Y + 28 + 16 
        if totalHeight < 60 then totalHeight = 60 end
...
endfunction Menghub:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title   = NotifyConfig.Title   or "Meng Hub"
    NotifyConfig.Content = NotifyConfig.Content or "Notification"
    NotifyConfig.Color   = NotifyConfig.Color   or Color3.fromRGB(176, 110, 243)
    NotifyConfig.Time    = NotifyConfig.Time    or 0.35
    ...
    spawn(function()
            ...
            CoreGui.NotifyGui.NotifyLayout.ChildRemoved:Connect(function()
                ...
                for _, v in CoreGui.NotifyGui.NotifyLayout:GetChildren() do
                    ...
                    TweenService:Create(v,
                        ...
                        { Position = UDim2.new(0, 0, 1, -((v.Size.Y.Offset + 8) * (count + 1))) }
                    ):Play()
                    count += 1
                end
            end)
        ...
        -- hitung posisi Y (stack dari bawah ke atas)
        local posY = 0
        for _, v in CoreGui.NotifyGui.NotifyLayout:GetChildren() do
            if v:IsA("Frame") then
                posY = posY + v.Size.Y.Offset + 8
            end
        end

        local H = 58 -- tinggi notif

        -- outer wrapper
        local NotifyFrame = Instance.new("Frame")
        NotifyFrame.BackgroundTransparency = 1
        NotifyFrame.BorderSizePixel = 0
        NotifyFrame.Size = UDim2.new(1, 0, 0, H)
        NotifyFrame.Position = UDim2.new(0, 300, 1, -(posY + H))
        NotifyFrame.Name = "NotifyFrame"
        NotifyFrame.Parent = CoreGui.NotifyGui.NotifyLayout
        ...
        Content.TextColor3 = Color3.fromRGB(150, 150, 165)
        Content.TextSize = 11
        Content.TextXAlignment = Enum.TextXAlignment.Left
        Content.TextTruncate = Enum.TextTruncate.AtEnd
        Content.Size = UDim2.new(1, -20, 0, 16)
        ...
        function NotifyFunction:Close()
            ...
            waitbruh = true
            TweenService:Create(NotifyFrame,
                TweenInfo.new(NotifyConfig.Time, Enum.EasingStyle.Quint, Enum.EasingDirection.In),
                { Position = UDim2.new(0, 300, 1, -(posY + H)) }
            ):Play()
        ...
        TweenService:Create(NotifyFrame,
            ...
            { Position = UDim2.new(0, 0, 1, -(posY + H)) }
        ):Play()
...
function notif(msg, delay, color, title, desc)
    return Menghub:MakeNotify({
        ...
        Content = msg or "",
        Color = color or Color3.fromRGB(176, 110, 243),
        Delay = delay or 4
    })
end
...
function Menghub:Window(GuiConfig)
    ...
    SearchInput:GetPropertyChangedSignal("Text"):Connect(function()
        ...
        -- Reset dulu semua highlight
        for _, page in LayersFolder:GetChildren() do
                        ...
                        if sectionAdd then
                            for _, item in sectionAdd:GetChildren() do
                                if item:IsA("Frame") then
                                    item.Visible = true
                                    if item:FindFirstChild("SearchHighlight") then
                                        item:FindFirstChild("SearchHighlight"):Destroy()
                                    end
                                end
                            end
                        end
                ...
                for _, section in page:GetChildren() do
                    if section.Name == "Section" then
                        ...
                        if sectionAdd then
                            for _, item in sectionAdd:GetChildren() do
                                if item:IsA("Frame") then
                                    local titleLabel = item:FindFirstChild("ToggleTitle")
                                        or item:FindFirstChild("SliderTitle")
                                        or item:FindFirstChild("DropdownTitle")
                                        or item:FindFirstChild("InputTitle")
                                        or item:FindFirstChild("ParagraphTitle")

                                    -- cek button (TextButton langsung di dalam ButtonFrame)
                                    ...
                                    if titleLabel then
                                        local match = string.find(string.lower(titleLabel.Text), query, 1, true) ~= nil
                                        if match then
                                            -- Jump ke tab dulu
                                            ...
                                            for _, v in sectionAdd:GetChildren() do
                                                if v.Name ~= "UIListLayout" then
                                                    contentH = contentH + v.Size.Y.Offset + 3
                                                end
                                            end
                                            ...
                                            -- Update warna title section jadi aktif
                                            if sectionRow then
                                                local sectionTitle = sectionRow:FindFirstChild("SectionTitle")
                                                local arrowImg = sectionRow:FindFirstChild("ArrowImg")
                                            ...
                                            -- Kasih highlight ke item
                                            local highlight = Instance.new("UIStroke")
                                            highlight.Name = "SearchHighlight"
                                            highlight.Color = GuiConfig.Color
                                            ...
                                            -- Scroll ke item
                                            task.wait(0.1)
                                            local scrollParent = page
                                            local itemPos = item.AbsolutePosition.Y - scrollParent.AbsolutePosition.Y + scrollParent.CanvasPosition.Y
                                            scrollParent.CanvasPosition = Vector2.new(0, itemPos - 10)
    ...
    if isMobile then
        ...
        UserInputService.InputChanged:Connect(function(inp)
            if lbDragging and inp.UserInputType == Enum.UserInputType.Touch then
    ...
    function Tabs:AddTab(TabConfig)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            function Items:AddCheckbox(CheckboxConfig)
                ...
                function CheckboxFunc:Set(Value)
                ...
                CheckboxFunc:Set(CheckboxFunc.Value)
