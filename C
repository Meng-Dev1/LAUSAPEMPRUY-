...
function Menghub:Window(GuiConfig)
    ...
    Close.Activated:Connect(function()
        ...
        Yes.MouseButton1Click:Connect(function()
            ...
            if game.CoreGui:FindFirstChild("MengCursorGui") then
                game.CoreGui.MengCursorGui:Destroy()
            end
        end)
    ...
    if not isMobile then
        ...
        CursorFrame.Size = UDim2.new(0, 10, 0, 10)
        CursorFrame.AnchorPoint = Vector2.new(0.5, 0.5)
        CursorFrame.BackgroundTransparency = 1
        CursorFrame.ZIndex = 99999
        CursorFrame.Visible = false
        CursorFrame.Active = false        -- ← biar ga nangkep klik
        CursorFrame.Interactable = false  -- ← biar ga nangkep klik
        ...
        Horizontal.ZIndex = 99999
        Horizontal.Active = false
        Horizontal.Parent = CursorFrame
        ...
        Vertical.ZIndex = 99999
        Vertical.Active = false
        Vertical.Parent = CursorFrame
        ...
        local function startCursor()
            ...
            cursorConn = game:GetService("RunService").Heartbeat:Connect(function()
                -- force unlock tiap frame biar game ga bisa re-lock
                UserInputService.MouseBehavior = Enum.MouseBehavior.Default
                local mp = UserInputService:GetMouseLocation()
                CursorFrame.Position = UDim2.new(0, mp.X, 0, mp.Y - inset.Y)
            end)
        end
        ...
        local function stopCursor()
            ...
            -- kembaliin ke lock sesuai kondisi game
        ...
        UserInputService.InputBegan:Connect(function(input, gpe)
            ...
            if input.KeyCode == ToggleKey then
                if DropShadowHolder then
                    local nowVisible = not DropShadowHolder.Visible
                    DropShadowHolder.Visible = nowVisible
                    if nowVisible then startCursor() else stopCursor() end
                end
            end
        end)
    end
